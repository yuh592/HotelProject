...
<div class="ct-img" style="margin: 10px 0px 20px 0px;">
          ...
          <div class="ct" style="border-radius:20px;border:2px solid #FFCACA;height:90%;width:50%;margin-left:25%;margin-top:3%;box-shadow: 5px 5px 8px #251B37, 10px 10px 8px #372948, 15px 15px 8px #FFCACA;">
              ...
              <form action="" method="post">
                  <div class="form1 " style="text-align:center;">
                      ...
                      <div>
                        ...
                        <input type="text" name="username" class="bg-inherit" style="padding: 8px 10px;width:50%;border-radius:10px;border:1px solid #FFCACA" value="<?php echo isset($data['username']) ? $data['username'] : ''; ?>" >
                        <br>
                      ...
                      <div>
                          ...
                          <input type="password" class="bg-inherit" name="password" style="padding: 8px 10px;width:50%;border-radius:10px;border:1px solid #FFCACA" value="<?php echo isset($data['password']) ? $data['password'] : ''; ?>" >
                          <br>
                      ...
                      <?php
                          if(isset($thongbao)&&($thongbao!="")){?>
                              ...
                              <div class="w-96 h-64 fixed inset-y-60 inset-x-1/3 rounded-lg shadow-2xl border-solid z-10 bg-white" style="margin-left:85px;">
                                  ...
                                  <p class="text-black pb-5 text-2xl text-center"><?php echo $thongbao;?></p>
                                    <div class="form4" style="text-align:center;">
                                      <button class="bg-gradient-to-r from-purple-500 to-pink-500" style="border: 1px solid #fff;border-radius: 10px;padding: 5px 35px;"><a href="./dangnhap.php" style="color: #FFCACA;text-decoration: none;">Back to login</a></button>
                                  </div>
                              </div>
                      ...
                      <div>
                          ...
                          <input type="text" class="bg-inherit" name="email" style="padding: 8px 10px;width:50%;border-radius:10px;border:1px solid #FFCACA" value="<?php echo isset($data['email']) ? $data['email'] : ''; ?>">
                          <br>
                      ...
                      <div>
                          ...
                          <input type="text" name="phone" class="bg-inherit text-black" style="padding: 8px 10px;width:50%;border-radius:10px;border:1px solid #FFCACA;" value="<?php echo isset($data['phone']) ? $data['phone'] : ''; ?>">
                          <br>
                          <span style="color: red;">
                      ...
                      <div>
                          ...
                          <input type="text" name="add" class="bg-inherit text-black" style="padding: 8px 10px;width:50%;border-radius:10px;border:1px solid #FFCACA;" value="<?php echo isset($data['add']) ? $data['add'] : ''; ?>" >
                          <br>
                          <span style="color: red;">
