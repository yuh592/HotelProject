                ...
                <div data-elementor-type="wp-post" data-elementor-id="187" class="elementor elementor-187" data-elementor-settings="[]">
                    <div class="elementor-inner">
                        <div class="elementor-section-wrap">
                            ...
                            <section class="elementor-section elementor-top-section elementor-element elementor-element-b10bbac elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="b10bbac" data-element_type="section" data-settings='{"hoteller_ext_is_background_parallax":"false","hoteller_ext_is_background_on_scroll":"false"}'>
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-row">
                                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-f92e7d3" data-id="f92e7d3" data-element_type="column" data-settings='{"hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}'>
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element elementor-element-1a06f2b elementor-widget elementor-widget-hoteller-availability-search" data-id="1a06f2b" data-element_type="widget" data-settings='{"hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="hoteller-availability-search.default">
                                                        <div class="elementor-widget-container">
                                                                ...
                                                                <div class="mphb_sc_search-wrapper">
                                                                    <form method="POST" class="mphb_sc_search-form" action="../../../app/controllers/user/index.php?act=home">
                                                                        ...
                                                                        <p class="mphb_sc_search-check-in-date">
                                                                            ...
                                                                            <input id="mphb_check_in_date-mphb-search-form-6061a36060295" data-datepick-group="mphb-search-form-6061a36060295" value="<?php echo isset($data['ngayden']) ? $data['ngayden'] : ''; ?>" placeholder="Check-in Date" type="date" name="ngayden" class="ngayden mphb-datepick" autocomplete="off" />
                                                                        ...
                                                                        <p class="mphb_sc_search-check-out-date">
                                                                            ...
                                                                            <input id="mphb_check_out_date-mphb-search-form-6061a36060295" data-datepick-group="mphb-search-form-6061a36060295" value="<?php echo isset($data['ngaytra']) ? $data['ngaytra'] : ''; ?>" placeholder="Check-out Date" type="date" name="ngaytra" class="ngaytra mphb-datepick" autocomplete="off" />
                                                                        ...
                                                                        <p class="mphb_sc_search-adults">
                                                                            ...
                                                                            <select id="mphb_adults-mphb-search-form-6061a36060295" name="sokhach">
                                                                                <option class="text-black" value="1" selected="selected">1</option>
                                                                        ...
                                                                        <p class="mphb_sc_search-children">
                                                                            ...
                                                                            <select id="mphb_children-mphb-search-form-6061a36060295" name="sokhach">
                                                                                <option class="text-black" value="0" selected="selected">0</option>
                                                                        ...
                                                                        <p class="mphb_sc_search-submit-button-wrapper">
                                                                            <input type="submit" name="submit" class="submit_btn" value="Search" />
                                        ...
                                        <div class="shadow-lg p-2">
                                            ...
                                            <div>
                                                ...
                                                <div class=" text-2xl flex">
                                                    ...
                                                    <p class="font-bold text-3xl text-stone-700 "><?php echo number_format($item['price']) ?> vnd/đêm</p>

                                                </div>
                                                <div class="flex">
                                                    <i class="text-4xl fa-solid fa-bed"></i>
                                                    <div class=" flex  ">
                                                        <i class="text-4xl ml-8 mr-2 fa-solid fa-users"></i>
                                                        <div class="text-3xl pt-3 font-bold"><?php echo $item['sokhach'] ?> người</div>
                                                    </div>
                                                </div>
                                                <p class="w-96 text-ellipsis overflow-hidden whitespace-nowrap font-serif text-2xl"><?php echo $item['mota'] ?></p>
                                                <div>
                                                    <button class="bg-stone-700 text-white rounded border border-white border-solid p-2 ">Xem chi tiết</button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                        ...
                                        <div class="shadow-lg p-2 ">
                                            ...
                                            <div>
                                                ...
                                                <a href="index.php?act=room&id=<?php echo $item['id_phong'] ?>">
                                                    ...
                                                    <div class=" text-2xl flex">
                                                        <p class="font-bold text-3xl text-amber-600 "><?php echo number_format($item['price']) ?> vnd/đêm</p>
                                                ...
                                                <div>
                                                    <a href="index.php?act=room&id=<?php echo $item['id_phong'] ?>">
                                                        <button class="bg-amber-600 text-white rounded border border-white border-solid p-2 hover:border-y-amber-700 hover:border-x-neutral-50 hover:bg-white shadow-lg hover:text-amber-600">Xem chi tiết</button>
                                                    </a>
                                            ...
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element elementor-element-e4d6ae5 elementor-invisible elementor-widget elementor-widget-image" data-id="e4d6ae5" data-element_type="widget" data-settings='{"_animation":"fadeIn","hoteller_image_is_animation":"false","hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="image.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-image">
                                                                <img width="1947" height="555" src="../../../public/upload/hotel-sketch.png" class="attachment-full size-full" alt="" loading="lazy" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="elementor-container elementor-column-gap-default">
                                    <div class="elementor-row">
                                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-b7f2abc" data-id="b7f2abc" data-element_type="column" data-settings='{"hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}'>
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element elementor-element-8b6f69b elementor-invisible elementor-widget elementor-widget-heading" data-id="8b6f69b" data-element_type="widget" data-settings='{"_animation":"fadeInUp","hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="heading.default">
                                                        <div class="elementor-widget-container">
                                            ...
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="elementor-element elementor-element-2bae295 elementor-invisible elementor-widget elementor-widget-heading" data-id="2bae295" data-element_type="widget" data-settings='{"_animation":"fadeInUp","hoteller_ext_is_scrollme":"false","hoteller_ext_is_smoove":"false","hoteller_ext_is_parallax_mouse":"false","hoteller_ext_is_infinite":"false","hoteller_ext_is_fadeout_animation":"false"}' data-widget_type="heading.default">
                                                        <div class="elementor-widget-container">
                                                            <span class="elementor-heading-title elementor-size-default">Offers</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
