        ...
        <form action="" method="post">
            ...
            <?php
                    if(isset($thongbao)&&($thongbao!="")){?>
                      ...
                      <div class="w-1/3 h-1/3 text-center fixed inset-y-60 inset-x-1/4 rounded-lg shadow-2xl border-solid z-10 bg-white" style="margin-left:133px;">
                        ...
                        <div class="form4" style="text-align:center;">
                          <button class="bg-gradient-to-r from-purple-500 to-pink-500" style="border: 1px solid #fff;border-radius: 10px;padding: 5px 35px;">
                            <a href="./dangnhap.php" style="color: #FFCACA;text-decoration: none;">Back</a>
                          </button>
                        </div>
                      </div>
