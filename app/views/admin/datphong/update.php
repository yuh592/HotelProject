<div class="row">
    <div class="row mb headeradmin" style="width:1050px;">
        <h1 style="padding: 15px 0;">CẬP NHẬT ĐẶT PHÒNG</h1>
    </div>
            ...
            <div class="row">
                ...
                <div class="row mb10 content1">
                    ...
                    <div class="row mb10">
                        ...
                        <input type="tongtien" name="tongtien" style="width:120%;border: 1px solid #2a2f8c;padding: 10px;border-radius: 5px;" value="<?= $tongtien ?>">
                    </div>
                </div>
                <div class="row mb10 content2">
                    <div class="row mb10">
                        <label for="">NGÀY ĐẾN</label><br>
                        <input type="date" name="ngayden" style="width:120%;border: 1px solid #2a2f8c;padding: 10px;border-radius: 5px;" value="<?= $ngayden ?>">
                    </div>
                    <div class="row mb10">
                        <label for="">NGÀY TRẢ</label><br>
                        <input type="date" name="ngaytra" style="width:120%;border: 1px solid #2a2f8c;padding: 10px;border-radius: 5px;" value="<?= $ngaytra ?>">
                    </div>
                    <div class="row mb10">
                        <label for="">GIAO DỊCH</label><br>
                        <select name="giaodich" id="" style="border: 1px solid #2a2f8c; padding: 10px; border-radius: 5px; width: 120%;">
